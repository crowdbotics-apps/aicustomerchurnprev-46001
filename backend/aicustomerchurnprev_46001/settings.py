"""
Django settings for aicustomerchurnprev_46001 project.
...
ROOT_URLCONF = 'aicustomerchurnprev_46001.urls'
...
WSGI_APPLICATION = 'aicustomerchurnprev_46001.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "aicustomerchurnprev_46001 API",
    "DESCRIPTION": "API documentation for aicustomerchurnprev_46001 App",
    "VERSION": "v1",
}
